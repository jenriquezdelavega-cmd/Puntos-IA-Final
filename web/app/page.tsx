    ...
    <main className="relative min-h-screen overflow-hidden bg-[#05050a] text-white">
      ...
      <section className="relative z-10 mx-auto w-full max-w-6xl px-6 py-8">
        <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-6 md:p-8">
          <p className="text-[11px] font-black uppercase tracking-[0.2em] text-white/45">Confianza comercial</p>
          <h3 className="mt-2 text-2xl font-black text-white md:text-3xl">Diseñado para industrias con alta recompra.</h3>
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            {[
              { title: 'Cafeterías y alimentos', desc: 'Incrementa frecuencia de visita y acelera segundas compras semanales.' },
              { title: 'Belleza y bienestar', desc: 'Convierte clientes eventuales en recurrentes con metas y beneficios claros.' },
              { title: 'Retail local', desc: 'Activa promociones de retorno y mide impacto por campaña y temporada.' },
            ].map((item) => (
