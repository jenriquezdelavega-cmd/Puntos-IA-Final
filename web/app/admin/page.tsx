...
{userRole === 'ADMIN' && <button onClick={()=>setTab('settings')} className={`p-3 rounded-xl ${tab==='settings'?'bg-gray-800 text-white':'text-gray-400'}`}> <span className="hidden md:inline ml-2">Config</span></button>}
</nav>
